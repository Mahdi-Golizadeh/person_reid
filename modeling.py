...
class SEResNetBottleneck(Bottleneck_):
    """
...
class SEResNeXtBottleneck(Bottleneck_):
    """
...
def build_model(num_classes):
    ...
    model = Baseline(num_classes, MODEL_LAST_STRIDE, MODEL_PRETRAIN_PATH, MODEL_NECK, TEST_NECK_FEAT, MODEL_NAME, MODEL_PRETRAIN_CHOICE)
    return model